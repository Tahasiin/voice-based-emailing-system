...
if (isset($_POST["answer"])) {
    ...
    if ($answer === 'yes') {
        ...
        header('location:http://localhost/voice-based-emailing-system/check-inbox.php');
    } else {
...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <meta http-equiv="refresh" content="15;url=address-not-matched.php" />
    ...
    <body style="background: black" onload="startDictation()">
        ...
        <div class="text">
            <div style="display: none">
                <iframe  src="sounds/no-match.mp3" allow="autoplay" ></iframe>
